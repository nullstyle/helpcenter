{if $num_pages > 1}
<div class="pager">
  {if $page_num != 0}<a href="discuss.php?style={$filter_style}&amp;page={$page_num-1}{$filter_tag_arg}{$filter_product_arg}">&laquo; Prev</a>{/if}
  {section name=page loop=$num_pages}
    {if $smarty.section.page.iteration-1 < ($page_num+10) && $smarty.section.page.iteration-1 > $page_num-10}
